  ...
  if (cart.length === 0) {
    return (
      <div className="empty-cart-container flex-col flex-center animate-fade-in">
        ...
        <button onClick={() => navigate("/products")} className="btn btn-primary mt-md">
          Continue Shopping
        </button>
      </div>
    );
      ...
      <div className="cart-layout">
            ...
            <div key={item._id} className="cart-item">
              ...
              <div className="item-details">
                <div className="item-header flex-between">
                  <h4>{item.name}</h4>
                  <p className="item-price">₹{item.salePrice || item.price}</p>
                </div>
                ...
                <div className="item-actions flex-between">
                  <div className="quantity-control">
                    ...
                    <button
                      onClick={() => {
                        if (item.quantity < item.stock) increaseQty(item._id);
                      }}
                  ...
                  <button
                    ...
                    className="remove-btn flex-center"
                  >
                    <Trash2 size={16} />
        ...
        <div className="cart-summary">
          <div className="summary-card">
            ...
            <div className="secure-checkout mt-md">
              <p>🔒 Secure Checkout</p>
            </div>
          </div>
        </div>
